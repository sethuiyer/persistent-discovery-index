...
- **Thirty-one self-checking suites**, including closed-form toy validation, the
  ...
  frozen decision statistic (`o4b_stat.py`, `test_o4b_stat.py`), and the runner
  trace-persistence gate (`o4b_run.py`, `test_o4b_run.py`).
