...
- **Thirty self-checking suites**, including closed-form toy validation, the
  ...
  independent outcome evaluation (`evaluators.py`, `test_evaluators.py`), and the
  frozen decision statistic (`o4b_stat.py`, `test_o4b_stat.py`).
